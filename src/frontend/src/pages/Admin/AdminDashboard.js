...
export default function AdminDashBoard(props) {
  ...
  return (
    <Layout>
      ...
      <div className="site-card-wrapper my-5 flex md:flex-row flex-col justify-between md:p-3" >
        <Card
          title="Accounts"
          bordered={false}
        ...
        >
          <span className="text-4xl font-bold">{accountCount}</span>
        ...
        <Card
          ...
          className="text-center md:p-5 md:mx-2 mb-2"
        >
          <span className="text-4xl font-bold">{newAccountCount}</span>
        ...
        <Card
          ...
          className="text-center md:p-5 md:mx-2 mb-2"
        >
          <span className="text-4xl font-bold">{newCoursesCount}</span>
